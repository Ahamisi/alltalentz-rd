...
export default function Home() {
  return (
    <>
      ...
      <section
        className="relative bg-cover bg-center bg-no-repeat text-[#4C4C4C] py-[70px] bg-white px-[40px] md:px-0"
      ...
      >
        ...
        <div className="relative inset-0 flex flex-col items-center justify-center text-[#4C4C4C]">
          <h2 className="text-2xl md:text-5xl font-bold mb-8 text-center">Our Value Proposition</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8 max-w-6xl pt-[30px] md:pt-[70px] md:px-5 lg:px-0">
            ...
            <div className="flex flex-col">
              <div className="text-4xl mr-4 text-[#4C4C4C]">
                ...
                >
                  <path
                    opacity="0.3"
                    d="M51.9725 51.472C67.4058 36.0387 73.6614 17.2719 65.9448 9.55525C58.2281 1.83858 39.4614 8.09418 24.0281 23.5275C8.59479 38.9609 2.33921 57.7276 10.0559 65.4443C17.7725 73.161 36.5392 66.9054 51.9725 51.472Z"
                    fill="#282828"
                  />
                  <path
                    opacity="0.3"
                    d="M24.0275 51.4725C8.59417 36.0391 2.33859 17.2724 10.0552 9.55569C17.7719 1.83902 36.5386 8.09461 51.9719 23.528C67.4052 38.9613 73.6608 57.7281 65.9441 65.4447C58.2275 73.1614 39.4608 66.9058 24.0275 51.4725Z"
                    fill="#282828"
                  />
                  <path
                    d="M45.8125 37.5C45.8125 41.8147 42.3147 45.3125 38 45.3125C33.6853 45.3125 30.1875 41.8147 30.1875 37.5C30.1875 33.1853 33.6853 29.6875 38 29.6875C42.3147 29.6875 45.8125 33.1853 45.8125 37.5Z"
                    fill="#282828"
                  />
                </svg>
              </div>
              <div>
                ...
                <p className="text-lg">
                  Our remote talent are trained and certified in the latest skills, techniques and
                  proficient in the software required.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col">
              ...
              <div>
                ...
                <p className="text-lg">
                  Save up to 70% on cost when you use our remote talent which leads to considerable
            ...
            <div className="flex flex-col">
              ...
              <div>
                ...
                <p className="text-lg">
                  Our remote talent are vetted and verified by us, and we provide ongoing support
                  and feedback to ensure quality and satisfaction.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col">
              ...
              <div>
                ...
                <p className="text-lg">
                  Our talent understand the job and are solutions-oriented; ultimately, they
      ...
      {/* svg home wrapper */}
      <section
        className="relative bg-cover bg-center bg-no-repeat md:py-[68px] bg-[#0E0E0E] "
      ...
      >
        ...
        <div className=" text-white px-[40px] md:px-0">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl md:text-[65px] md:leading-[80px] font-bold mb-8 text-center">
              Clients that <span className="text-secondary">trust</span> us!
            </h2>
            <p className="text-lg text-center max-w-3xl mx-auto mb-12">
              All Talentz provides employee recruitment services for over 30 Puroclean Franchises in
              the US and we have created job opportunities for 50 remote employees across Nigeria
              since we commenced operations in March 2022.
            </p>
            <ClientCarousel />
            {/* <Clients/> */}
          </div>
        ...
        <div className="py-16 md:pt-[200px] text-white px-[40px] md:px-0 ">
          <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center">
            ...
            <div className="lg:w-1/2 lg:pr-8 mb-8 lg:mb-0 md:text-center md:items-center lg:text-left">
              <h2 className="text-2xl md:text-[65px] md:leading-[80px] font-bold mb-4">
                {" "}
                The All Talentz <span className="text-secondary">Conference</span>
              </h2>
              <p className="text-lg mb-6">
                The All-Talentz Conference is an annual event/retreat where all talents in
                All-Talentz go through a re-orientation in excellence and service delivery.
              </p>
            ...
            <div className="md:w-1/2">
              <video width="100%" controls poster="/at-video-cover.png">
                <source
                  src="/video/at-video.mp4"
                  type="video/mp4"
                  alt=" All-Talentz annual Conference event"
                />
              </video>
            </div>
          </div>
          ...
          <div className="max-w-6xl md:w-[90%] mx-auto flex flex-col md:flex-row justify-center">
            ...
            <div className="px-[40px] flex flex-col flex-1">
              <div className=" mr-auto">
                ...
                />
                <h3 className="text-lg font-semibold text-secondary md:text-[25px] mb-[18px]">
                  Quality Talent At A Bargain
                </h3>
                <p className="text-md">
                  Flexible labour that scales with your company. We employ the talent, therefore
                  there are no payroll costs, benefit costs, or high overhead costs that accrue to
                  you.
                </p>
              </div>
            </div>
            ...
            <div className="px-[40px] flex flex-col flex-1 mt-[30px] md:mt-0">
              <div className=" mr-auto">
                ...
                />
                <h3 className="text-lg font-semibold text-secondary md:text-[25px] mb-[18px]">
                  Top-Tier Talent From Day 1
                </h3>
                <p className="text-md">
                  Our talents are on the money, and we're determined to meet your company's demands
                  and keep them in line with best practices. If you are not satisfied with our
                  Talent after 30 days, we'll replace them.
                </p>
              </div>
            </div>
          </div>
        ...
        <div
          className="py-16 bg-white rounded-[32px] text-[#4C4C4C] text-center w-[100%] md:w-[80%] mx-auto mt-[90px] bg-cover bg-center px-[40px] md:px-0"
          style={{ backgroundImage: "url('/orange-clients.svg')" }}
        >
            ...
            <div className="flex flex-col lg:flex-row justify-between gap-[42px] w-[90%] mx-auto">
              ...
              <div className="flex flex-col items-center bg-secondary p-[40px] flex-1 border-4 border-transparent hover:border-black transition duration-300 cursor-pointer h-auto">
                ...
                >
                  ...
                  <path
                    opacity="0.5"
                    d="M44.2554 74.4791V97.5C44.2554 107.714 44.2554 112.821 47.4284 115.994C50.6014 119.167 55.7083 119.167 65.922 119.167C76.1358 119.167 81.2427 119.167 84.4157 115.994C87.5887 112.821 87.5887 107.714 87.5887 97.5V74.4791H44.2554Z"
                    fill="#282828"
                  />
                ...
                <p className="text-lg">
                  We have a wide range of Talent just right for you at your fingertips.
                </p>
              </div>
              ...
              <div className="flex flex-col items-center bg-secondary p-[40px] flex-1 border-4 border-transparent hover:border-black transition duration-300 cursor-pointer">
                ...
                >
                  <path
                    d="M77.01 18.9564C69.3129 15.3479 60.687 15.3479 52.9899 18.9564L16.7463 35.9482C10.918 38.6807 9.39844 46.3857 12.1877 51.7111L12.1877 78.5417C12.1877 80.7853 14.0065 82.6042 16.2502 82.6042C18.4938 82.6042 20.3127 80.7853 20.3127 78.5417V57.8069L52.9904 73.1269C60.6875 76.7355 69.3133 76.7355 77.0105 73.1269L113.254 56.1351C121.138 52.439 121.138 39.6446 113.254 35.9485L77.01 18.9564Z"
                    fill="#1C274D"
                  />
                  <path
                    opacity="0.5"
                    d="M27.0835 60.9812L52.9904 73.1269C60.6875 76.7355 69.3133 76.7355 77.0105 73.1269L102.917 60.9814V90.0534C102.917 95.5136 100.19 100.626 95.4129 103.271C87.4593 107.676 74.7285 113.749 65.0002 113.749C55.2718 113.749 42.5411 107.676 34.5874 103.271C29.8108 100.626 27.0835 95.5136 27.0835 90.0534V60.9812Z"
                    fill="#373737"
                  />
                </svg>
              ...
              <div className="flex flex-col items-center bg-secondary p-[40px] flex-1 border-4 border-transparent hover:border-black transition duration-300 cursor-pointer">
                ...
                <p className="text-lg">
                  All Talentz onboards Talent with necessary work tools and introduces Talent to new
                  clients to commence work​​.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-6xl mx-auto my-16 grid gap-6 grid-cols-1 sm:grid-cols-2 text-[#363636]">
          <div
            className="bg-white shadow-lg rounded-lg py-10 px-[50px] md:px-[80px] bg-cover bg-center bg-no-repeat lg:h-[320px]"
            style={{ backgroundImage: "url('/find-talents-bg.svg" }}
          >
      ...
      {/* testimonial */}
      <section
        className="relative bg-cover bg-center bg-no-repeat text-[#282828] py-[50px] md:py-[70px] bg-secondary px-[40px] md:px-0"
        style={{ backgroundImage: "url('/abs-orange.svg')" }}
      >
        {/* <div className="absolute inset-0 bg-gradient-to-b from-transparent to-black"></div> */}
