...
export const metadata = {
  ...
  description: 'Find vetted remote professionals from Africa across Tech, Healthcare, Finance, Legal & Construction. 70% cost savings with AllTalentz.',
...
export default function FindTalentLayout({ children }) {
  return (
    <>
