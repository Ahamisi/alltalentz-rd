...
export const metadata = {
  ...
  description:
    "AllTalentz connects U.S. and global businesses with pre-vetted remote professionals in IT, Healthcare, Finance, Restoration, and Legal — saving up to 70% on hiring costs. Learn how we work.",
