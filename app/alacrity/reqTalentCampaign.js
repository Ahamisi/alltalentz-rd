          ...
          <div className="max-w-6xl mx-auto  py-12 md:flex relative h-fit items-center mt-6 md:mt-0 px-[20px] md:px-4 ">
            ...
            <div className="md:w-5/10 pr-6 md:w-full lg:mt-[5%]">
              <h2 className="text-2xl md:text-[65px] md:font-[700] md:leading-[70px] font-bold mb-6 text-black text-left">
                Save up to <span className="text-secondary">75%</span>
                <br /> on your empoyee payroll budget!
              </h2>

              <div className="flex items-left flex-col space-y-[40px]">
                <a
                  href="#formInter"
                  className="flex space-x-[17px] gap-[17px] py-[16px] px-[30px] md:px-[52px] rounded-[32px] items-center border-[2px] font-bold border-black text-black hover:bg-black hover:text-white md:w-[60%] md:ml-[90px]"
                >
                  <div>
                    <img
                      src="/special-events/tampa-build-expo.png"
                      alt="Tampa alltalentz"
                      className="h-[50px]"
                    />
                  </div>
                  February 7 - 8, 2024
                ...
                <div className="w-full">
                  <p className="text-black text-sm md:text-lg text-justify">
                    Get 50% off your first month payment when you sign up at{" "}
                    <span className="text-black font-bold text-center">
                      <br />
                      Tampa Build Expo 2024.
                    </span>
                  </p>
                </div>
              </div>

              <div className="flex md:block flex-column mt-6 md:mt-0"></div>
