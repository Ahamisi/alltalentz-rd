...
export default function RequestTalent() {
  ...
  return (
    ...
    <section
      className={`relative bg-cover bg-center bg-no-repeat mt-[0px] px-[20px] md:px-0 lg:px-0 bg-[#3E174F] lg:h-screen`}
    >            {/* <div className="relative inset-0 h-[100%] flex flex-col items-center"> */}
            ...
            <div className={`flex items-center justify-center h-[100%] `}>
                ...
                Save up to <span className="text-secondary">75%</span> on your empoyee payroll budget!
                </h2>

                <div className="flex items-center flex-col space-y-[40px]">
                    <a href="#formInter" className="flex space-x-[17px] py-[16px] px-[30px] md:px-[52px] rounded-[32px] items-center border-[2px] font-bold border-[#41DAFF]">
                        <div>
                            <img src="/inter-connect.svg"/>
                        </div>
                        January 21 - 24, 2024
                    </a>

                         
                    <p className="text-[#41DAFF] text-sm md:text-lg text-center font-bold">
                    Get 50% off your first month payment when you sign up at <span className="text-white">Interconnect Conference 2024</span> by CoreLogic.
                    </p>
                </div>
               ...
               <div className="flex md:block flex-column mt-6 md:mt-0">
                    ...
                    <div className="hidden lg:block md:w-4/10 mt-8 md:mt-0">
                        <img
                            src="/union-interconnect-lg.png"
                            alt="Union InterConnect"
        ...
        <div className="relative inset-0 flex flex-col items-center justify-center text-[#4C4C4C] " id="formInter">
          ...
          <div className={`modal-content w-[100] overflow-y-auto ${isSubmitted ? 'w-full pt-7' : 'bg-white md:w-[60%] p-3 mx-auto'}`}>
                            ...
                            <form onSubmit={handleSubmit} className="text-[#A6A6A6]" >
                                                            <h2 className="text-[25px] font-normal text-center mb-8 text-[#4C4C4C]">Kindly Please fill this form to help us find you the right talent</h2>
