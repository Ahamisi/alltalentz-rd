          ...
          <div className="max-w-6xl mx-auto  py-12 md:flex relative h-fit items-center mt-6 md:mt-0 px-[20px] md:px-4">
            ...
            <div className="md:w-6/10 pr-6 md:w-full">
              <h2 className="text-2xl md:text-[55px] md:font-[700] md:leading-[70px] font-bold mb-6 text-white">
                Welcome to a world of <span className="text-secondary">amazing talents</span> to
                help scale your operations
              </h2>

              <p className="text-white text-sm md:text-base">
                Prepare to be amazed by the incredible talents that can take your operations to the
                next level! You have come to the right place to find the best solutions for your
                needs. Whether you are looking for experts, innovators, or collaborators, you will
                find them here. Don't miss this opportunity to work with the most amazing talents in
                the world!
              </p>
              ...
              >
                <div
                  className={`modal-content w-[100] overflow-y-auto ${isSubmitted ? "w-full pt-7" : "bg-white md:w-[80%] p-3 mx-auto"}`}
                >
                  <button
                    onClick={toggleModal}
                  ...
                  {isSubmitted ? (
                    ...
                    <form onSubmit={handleSubmit} className="text-[#A6A6A6]">
                      <h2 className="text-lg font-normal text-center mb-8 text-[#939393]">
                        Please fill this form to help us find you the right talent
                      </h2>
                      <div className="mb-8">
            ...
            <div className="hidden lg:block md:w-4/10 mt-8 md:mt-0">
              <img src="/our-talents.png" alt="All Talents Africa" className="w-full h-auto" />
            </div>
          </div>
          {/* </div> */}
        </PageHeader>
