                        ...
                        <div className="flex items-center mb-2">
                            <div>
                                <svg className="w-[51px] h-[51px] md:w-[76px] md:h-[76px]" viewBox="0 0 76 76" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <g opacity="0.5">
                                    <path fillRule="evenodd" clipRule="evenodd" d="M34.4355 30.3042C34.4355 28.1468 36.1844 26.3979 38.3418 26.3979C40.4992 26.3979 42.248 28.1468 42.248 30.3042C42.248 32.4616 40.4992 34.2104 38.3418 34.2104C36.1844 34.2104 34.4355 32.4616 34.4355 30.3042Z" fill="#1C274C"/>
                                    <path fillRule="evenodd" clipRule="evenodd" d="M34.4355 30.3042C34.4355 28.1468 36.1844 26.3979 38.3418 26.3979C40.4992 26.3979 42.248 28.1468 42.248 30.3042C42.248 32.4616 40.4992 34.2104 38.3418 34.2104C36.1844 34.2104 34.4355 32.4616 34.4355 30.3042Z" fill="#282828"/>
                                    </g>
