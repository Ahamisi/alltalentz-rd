...
export default function BootCamp() {
  ...
  const bootcampImg1 = isMobile
    ? "/bootcamp/mobile-banner-bootcamp5.jpg"
    : "/bootcamp/alltalentzbanne5.jpg";
        ...
        const countdownInterval = setInterval(() => {
          setCountdown((prevCountdown) => {
            if (prevCountdown === 0) {
              ...
              console.log("done");
              route.push(
                "https://forms.office.com/pages/responsepage.aspx?id=fhgFiTIHCkquTYO-BRMRBfQf36Oi-MZHkm_eYMKcGU9UMTkwQ1RXVDFOVzBIVk5US0g5T0NBM0NBWi4u&route=shorturl"
              );
              ...
              <div className="w-full lg:w-1/2 p-6 items-center justify-center h-auto lg:pl-0  lg:h-[580px]">
                <div className="md:w-full flex flex-col gap-[30px] mt-[40px] lg:mt-[40px] xl:mt-[80px]">
                  <img
                    src={bootcampImg}
                    alt="Bootcamp"
                    className="h-[287px] w-[327px] sm:h-auto sm:w-auto"
                  />
                  <p className="text-[#FEF5E9] text-md md:text-[20px]">
                    Join the ALL TALENTZ Estimate writing bootcamp and embark on a transformative
                  ...
                  <div className="text-white">
                    ...
                    <p className="text-[16px] font-bold leading-[30px] text-[#F99621] mt-2px">
            ...
            {bootCampOver ? (
              <div className="flex flex-col items-center text-black">
                ...
                <h1 className="text-[22px] text-center font-bold">
                  Oops, the bootcamp application period is over.
                </h1>
              ...
              <div className="modal-content p-3 w-[100] md:w-[80%] mx-auto overflow-y-auto">
                ...
                {isSubmitted ? (
                  <div className=" p-4 rounded-lg bg-[##FDDEBA] text-center mt-6 bg-white w-full m-0">
                    ...
                    <br />
                    <Btn
                      link="https://forms.office.com/pages/responsepage.aspx?id=fhgFiTIHCkquTYO-BRMRBfQf36Oi-MZHkm_eYMKcGU9UMTkwQ1RXVDFOVzBIVk5US0g5T0NBM0NBWi4u&route=shorturl"
                      target="_blank"
                      text="Take Test Now"
                      className="mt-6"
                    />
              ...
              <div className="text-4xl mr-4 text-[#4C4C4C] text-center">
                ...
                >
                  ...
                  <path
                    fillRule="evenodd"
                    clipRule="evenodd"
                    d="M29.8848 59.2406C29.8848 57.9298 30.9341 56.8672 32.2285 56.8672H44.7285C46.0229 56.8672 47.0723 57.9298 47.0723 59.2406C47.0723 60.5514 46.0229 61.614 44.7285 61.614H32.2285C30.9341 61.614 29.8848 60.5514 29.8848 59.2406ZM31.9681 67.152C31.9681 65.8412 33.0174 64.7786 34.3119 64.7786H42.6452C43.9396 64.7786 44.9889 65.8412 44.9889 67.152C44.9889 68.4628 43.9396 69.5254 42.6452 69.5254H34.3119C33.0174 69.5254 31.9681 68.4628 31.9681 67.152Z"
                    fill="#1C274C"
                  />
                </svg>
              </div>
              <div>
                ...
                <div>
                  <ul className="text-[16px] font-bold text-[#060606]  list-disc leading-[28px] ">
                    ...
                    <li className="text-[#060606]">
                      Mastering industry specific tools and software.
                    </li>
              ...
              <div>
                ...
                <div>
                  <ul className="text-[16px] font-bold text-[#060606]  list-disc leading-[28px] ">
                    ...
                    <li className="text-[#060606]">
                      Opportunity to secure a permanent position with our entry level salary.
                    </li>
                    <li className="text-[#060606]">
