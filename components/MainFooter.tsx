          ...
          <div className="flex flex-col md:flex-row justify-between items-start gap-8 mb-8">
            ...
            <div className="flex flex-col md:flex-row gap-8 flex-1">
              <div>
                ...
                <ul className="text-white">
                  <li className="mb-[12px]">
                    <Link href="faq" className="hover:text-secondary font-light">
                      FAQs
                    </Link>
                  </li>
                  <li className="mb-[12px]">
                    <Link href="our-watchlist" className="hover:text-secondary font-light">
                      Careers
                    </Link>
                  </li>
                  <li className="mb-[12px]">
              ...
              <div>
                ...
                <ul className="text-white">
                  <li className="mb-[12px]">
                    <Link href="bootcamp" className="hover:text-secondary font-light">
                      Jobs
                    </Link>
                  </li>
                  <li className="mb-[12px]">
              ...
              <div>
                ...
                <ul className="text-white">
                  <li className="mb-[12px]">
                    <Link href="privacy-policy" className="hover:text-secondary font-light">
                      Privacy Policy
                    </Link>
                  </li>
                  <li className="mb-[12px]">
              ...
              <form>
                <div className="flex flex-col lg:flex-row gap-4 justify-end">
                  ...
                  <Btn
                    text="Subscribe"
                    target="_blank"
                    link="https://blog.alltalentz.com"
                    otherCSS="text-center"
                  />
                </div>
              </form>
              <p className="text-white mt-4 text-sm font-light">
                By entering your email address, you confirming that you are agree to subscribe into
                our newsletter
              </p>
            </div>
          </div>
