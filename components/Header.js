  ...
  return (
    ...
    <header className={`${type == 'bootcamp' ? 'lg:w-[79%] px-4 md:px-0' : 'max-w-7xl'} md:mx-auto`}>
      ...
      <ul className={`hidden lg:flex text-white text-lg ${type  == 'bootcamp' ? 'gap-[54px] lg:ml-[20%]' : 'lg:gap-7'}   font-normal`}>
        ...
        {
          type == "bootcamp" ? <NavigationBootcamp/> : <Navigation/>
        }
        </ul>
      {/* Mobile Menu */}
      ...
      {/* <Button text='Get Started' onClick="" /> */}
        ...
        {mobileMenuOpen && (
            ...
            <ul className="space-y-2 text-primary text-lg">
                {
                  type == "bootcamp" ? <NavigationBootcamp/> : <Navigation addBootcamp={true} />
                }
