			...
			<section className="py-24 bg-white">
				<div className="flex flex-col space-y-8 items-center">
					<p className="text-center text-lg text-gray-700 max-w-4xl mx-auto">
						In the race to innovate, access to the right technical talent is
						your most critical advantage. All Talentz provides the vetted
						engineers, data experts, and support specialists you need to
						accelerate development, refine algorithms, and scale your operations
			...
			<section className="bg-white grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 px-4 md:px-8 lg:px-16 items-center my-16 md:my-24 lg:my-32">
				...
				<div className="flex flex-col justify-center items-center md:items-start px-4 md:px-0">
					...
					<p className="text-sm sm:text-base md:text-lg text-gray-700 mb-6 md:mb-8 text-center md:text-left max-w-xl">
						We understand sprint cycles, agile methodologies, and the need for
						technically fluent communication. Our talent is trained to integrate
						quickly and contribute to your codebase, data pipelines, and product
						goals from day one.
					</p>
