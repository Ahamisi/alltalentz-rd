  ...
  const Talents = [
    {
      ...
      description: 'Ensure accurate coding, timely claims submission, and optimized revenue cycle management.',
    ...
    },
    {
      ...
      description: 'Support medical research and AI diagnostics by meticulously labeling medical imaging, genomic data, and clinical notes.',
    ...
    },
    {
      ...
      description: 'Manage patient scheduling, records coordination, and provider communication with discretion and efficiency.',
    ...
    },
    {
      ...
      description: 'Provide patient outreach, appointment reminders, and triage support with empathy and professionalism.',
    ...
    },
    {
      ...
      description: 'Build and maintain secure, HIPAA-compliant platforms, patient portals, and internal systems.',
  ...
  return (
    <div className='bg-white pb-24 px-4'>
      <section className="py-24 px-4 bg-white">
        <div className="flex flex-col space-y-8 items-center">
          <p className="text-center text-lg text-gray-700 max-w-4xl mx-auto">
            The healthcare and life sciences sector demands unparalleled accuracy, strict compliance, and
            specialized knowledge. All Talentz delivers trained professionals who understand these stakes,
            helping you streamline administrative functions, support research, and maintain patient focus
            without compromising on quality or regulations.
          </p>
          <Link 
            href="/request-talent" 
      ...
      <div className="relative flex justify-center md:justify-end px-4 md:px-0">
        ...
        We prioritize training in compliance basics (like HIPAA awareness), terminological accuracy, and the sensitive nature of healthcare data. Our talent acts as a seamless, secure extension of your team.
        </p>
