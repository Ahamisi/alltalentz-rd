...
const ValueProp = () => {
  ...
  return (
    <section
      ref={ref}
      className="relative bg-white py-20 bg-[url('/redesign-25/backgrounds/frame-pattern-1.svg')] bg-center bg-contain bg-no-repeat px-4 md:px-0"
    >
      {/* <section 
       ref={ref} 
     ...
     >
      ...
      >
        {/* Updated Header */}
        <motion.h2
          className="text-4xl md:text-5xl font-semibold text-center mb-16 text-black"
