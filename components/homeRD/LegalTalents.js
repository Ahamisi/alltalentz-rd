  ...
  const Talents = [
    {
      id: 1,
      title: 'Paralegals',
      description: 'Support attorneys with legal research, document drafting (pleadings, contracts, discovery), case file management, and trial preparation. ',
    ...
    },
    {
      ...
      description: 'Manage attorney calendars, client intake, billing correspondence, and document filing with a strong understanding of legal workflows. ',
    ...
    },
    {
      ...
      description: 'Accurately transcribe depositions, client meetings, hearings, and other legal proceedings. ',
    ...
    },
    {
      ...
      description: 'Meticulously review, tag, and categorize electronic documents for litigation support and discovery processes',
    ...
    },
    {
      ...
      description: 'Professionally handle initial client inquiries, schedule consultations, and provide clear case status updates. ',
      ...
      <section className="py-24 bg-white">
        <div className="flex flex-col space-y-8 items-center">
          <p className="text-center text-lg text-gray-700 max-w-4xl mx-auto">
            Precision, confidentiality, and rigorous process management are the foundations of legal work. All Talentz provides trained paralegals and legal support specialists who integrate seamlessly into your practice, helping you manage case loads, conduct research, and handle administrative tasks efficiently. Scale your firm's capabilities and focus on case strategy while we handle critical support functions. 
          </p>
          <Link 
            href="/request-talent" 
      ...
      <div className="relative flex justify-center md:justify-end px-4 md:col-span-1">
        <div className="relative w-full max-w-[380px] md:max-w-[420px] lg:max-w-[460px]">
          ...
          <div className="absolute w-[90%] h-[99%] bg-black/20 rounded-[24px] left-1/2 -translate-x-1/2 translate-y-4 md:translate-y-6"></div>
            ...
            <img 
            src="/redesign-25/legal-talents/legal-trust.png" 
            alt="Legal Trust" 
        ...
        We vet for discretion and train for the specific terminologies and procedures of the legal field. Our talent understands the importance of confidentiality, deadlines, and meticulous attention to detail, acting as a secure and reliable extension of your legal team. 
        </p>
    
        <div className='flex flex-col lg:flex-row gap-6'>
          <Link href="/contact-us" className="bg-[#F99621] text-white px-8 py-3 text-center mx-auto hover:bg-[#121212] transition duration-300">Hire Legal Talent</Link>
          <Link href="/contact-us" className="bg-[#FEF5E9] text-[#F99621] px-8 py-3 text-center mx-auto hover:bg-[#121212] transition duration-300">Discuss Your Compliance Needs</Link>
        </div>
    </div>
