	...
	return (
		<div className="border-b border-gray-200">
			...
			>
				...
				<span
					className={`ml-4 transition-transform duration-300 ${isOpen ? "-rotate-90" : ""}`}
				>
					<svg
						width="22"
						height="23"
...
const Faq = ({
	...
	return (
		<section className="relative bg-white py-20 bg-[url('/redesign-25/backgrounds/frame-pattern-2.webp')] bg-center bg-cover bg-no-repeat overflow-hidden px-4 md:px-0 lg:px-8 xl:px-0">
