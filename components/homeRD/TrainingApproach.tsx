    ...
    <section className="py-16 px-4 md:px-8 bg-white">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="p-6 transition-shadow flex items-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-16 text-[#121212]">
              Our Training
              <br />
              Approach!
            </h2>
          ...
          {approaches.map((item, index) => (
            ...
            >
              ...
              <p className="text-[#4C4C4C] text-base leading-relaxed">{item.description}</p>
            </div>
          ))}
        </div>
      </div>
