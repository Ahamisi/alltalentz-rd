              ...
              <div className="w-5/12 relative">
                ...
                <div className="bg-white rounded-lg p-6 border border-gray-100">
                  ...
                  <p className="text-gray-600">
                    2022 marked the humble beginning of All Talentz. We started with just 3
                    employees—a small but mighty team that became the foundation for everything
                    we've built today.
                  </p>
                </div>
              </div>
            ...
            <motion.div className="flex items-center justify-between relative">
              <div className="w-[35%] relative">
                ...
                <div className="bg-white rounded-lg p-6 border border-gray-100">
                  ...
                  <p className="text-gray-600">
                    By 2023, our team grew to 75 talented professionals. We continued our journey of
                    bridging African talents with businesses globally, completing more projects and
                    scaling operations.
                  </p>
                </div>
              </div>
            ...
            <motion.div className="flex items-center justify-between relative">
              ...
              <div className="w-[33%] relative">
                ...
                <div className="bg-white rounded-lg p-6 border border-gray-100">
                  <h3 className="text-[32px] font-bold mb-4 text-[#4C4C4C]">2023</h3>
                  <p className="text-gray-600">
                    In just a year, we opened our first physical office and launched our first
                    bootcamp, paving the way for more talent and innovation.
                  </p>
                </div>
              </div>
            </motion.div>
            ...
            <motion.div className="flex items-center justify-between relative">
              <div className="w-5/12 relative">
                ...
                <div className="bg-white rounded-lg p-6 border border-gray-100">
                  ...
                  <p className="text-gray-600">
                    Now in 2024, we are over 300 strong, delivering over 100,000 successful
                    projects. We're scaling faster, matching world-class African talents with global
