  ...
  const Talents = [
    {
      ...
      description: 'Build and maintain scalable applications with our full-stack, front-end, and back-end experts.',
    ...
    },
    {
      ...
      description: 'Integrate machine learning capabilities, develop models, and drive datadriven decision-making.',
    ...
    },
    {
      ...
      description: 'Create high-quality, structured training data sets to power your AI and machine learning initiatives.',
    ...
    },
    {
      id: 4,
      title: 'UI/UX Design',
      description: 'Design intuitive and engaging user experiences that drive product adoption and customer satisfaction.',
    ...
    },
    {
      ...
      description: 'Offload administrative and growth marketing tasks to focus your core team on product and strategy.',
      ...
      <section className="py-24 bg-white">
        <div className="flex flex-col space-y-8 items-center">
          <p className="text-center text-lg text-gray-700 max-w-4xl mx-auto">
            In the race to innovate, access to the right technical talent is your most critical advantage.
            All Talentz provides the vetted engineers, data experts, and support specialists you need to
            accelerate development, refine algorithms, and scale your operations without the overhead of
            traditional hiring.
          </p>
          <Link 
            href="/request-talent" 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-8 md:gap-y-20 mt-12 max-w-7xl mx-auto w-full px-4">
            {Talents.map((talent) => (
              <div key={talent.id} className={`flex flex-col ${talent.bgColor} text-black p-6 rounded-lg hover:shadow-lg transition duration-300`}>
                <h3 className="text-3xl md:text-4xl font-semibold max-w-4xl">
                  {talent.title}
                </h3>
      ...
      <div className="relative flex justify-center md:justify-end px-4 md:px-0">
        <div className="relative w-full max-w-[380px] md:max-w-[420px] lg:max-w-[460px]">
          ...
          <div className="absolute w-[90%] h-[99%] bg-black/20 rounded-[24px] left-1/2 -translate-x-1/2 translate-y-4 md:translate-y-6"></div>
            ...
            <img 
            src="/redesign-25/tech-talents/tech-leaders.png" 
            alt="Tech Leaders" 
        ...
        We understand sprint cycles, agile methodologies, and the need for technically fluent communication. Our talent is trained to integrate quickly and contribute to your codebase, data pipelines, and product goals from day one.
        </p>
