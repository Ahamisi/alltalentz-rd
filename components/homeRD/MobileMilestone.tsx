      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-12">
          ...
          >
            <h3 className="text-[32px] font-bold mb-4 text-[#4C4C4C]">2023</h3>
            <p className="text-gray-600">
              In just a year, we opened our first physical office and launched our first bootcamp,
              paving the way for more talent and innovation.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-gray-600">
              Now in 2024, we are over 300 strong, delivering over 100,000 successful projects.
              We're scaling faster, matching world-class African talents with global companies that
              trust us.
            </p>
          </motion.div>
