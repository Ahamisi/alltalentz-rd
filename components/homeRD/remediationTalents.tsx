  ...
  const Talents = [
    {
      ...
      title: "Estimators",
      description:
        "Prepare detailed, accurate cost estimates for labor and materials to ensure profitable project bidding and planning.",
    ...
    },
    {
      ...
      description:
        "Manage project-based invoicing, insurance claim paperwork,and collections to maintain healthy cash flow.",
    ...
    },
    {
      ...
      description:
        "Handle initial client intake, emergency dispatch coordination, and insurance follow-up calls.",
    ...
    },
    {
      ...
      description:
        "Support project managers with scheduling, contractor coordination, documentation, and customer updates",
    ...
    },
    {
      ...
      description:
        "Help grow your restoration business with local SEO, service area marketing, and lead generation campaigns",
      ...
      <section className="py-24 bg-white">
        <div className="flex flex-col space-y-8 items-center">
          <p className="text-center text-lg text-gray-700 max-w-4xl mx-auto">
            Construction/Reconstruction and restoration projects move fast under
            high-pressure conditions. All Talentz provides the critical behind-the-scenes talent to
            ensure accurate project  scoping, efficient administrative coordination, and clear
            client communication, helping you complete jobs on time and on budget with the fusion of
            tech+talent.
          </p>
          <Link
            href="/request-talent"
      ...
      <section className="bg-white grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 px-4 md:px-8 lg:px-16 items-center my-16 md:my-24 lg:my-32">
        ...
        <div className="flex flex-col justify-center items-center md:items-start px-4 md:w-[98%] md:col-span-2 false">
          ...
          <p className="text-sm sm:text-base md:text-lg text-gray-700 mb-6 md:mb-8 text-center md:text-left max-w-xl">
            We train our talent to understand the workflow of a restoration project, from emergency
            call to final invoice. This ensures they integrate smoothly with your field teams and
            external partners like insurance adjusters. 
          </p>
          ...
          <div className="flex flex-col lg:flex-row gap-6">
            ...
            >
              Hire Construction/Remediation Support
            </Link>
            <Link
