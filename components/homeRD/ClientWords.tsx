  ...
  return (
    <section className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold mb-4 text-[#1A1A1A]">{title}</h2>
          ...
          {testimonials
            ...
            .map((testimonial, index) => (
              ...
              >
                ...
                <div className="mb-6">
                  <svg
                    className={`w-12 h-12 ${styles.quoteIcon}`}
                    viewBox="0 0 24 24"
                    fill="currentColor"
                  >
                ...
                {/* Testimonial Quote */}
                <p className={`text-lg mb-8 ${styles.text}`}>{testimonial.quote}</p>

                {/* Thank you text if exists */}
                {testimonial.thankYou && (
                  <p className={`text-lg mb-8 ${styles.text}`}>{testimonial.thankYou}</p>
                )}
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h4 className={`font-bold text-lg ${styles.heading}`}>{testimonial.name}</h4>
            ...
            {[...Array(totalSlides)].map((_, index) => (
              <button
                ...
                className={`w-3 h-3 rounded-full transition-colors duration-300 ${
                  index === currentSlide ? "bg-[#FFB300]" : "bg-gray-300 hover:bg-gray-400"
                }`}
