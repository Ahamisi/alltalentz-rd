    ...
    <>
        ...
        <div className="max-w-6xl mx-auto px-4">
            ...
            <div className="col-span-1">
                ...
                <li><Link href="our-watchlist">Careers</Link></li>
            ...
            <div className="col-span-2 md:col-span-2">
                ...
                <form>
                    <input
                        ...
                        className="py-2 px-4 text-[#4C4C4C] rounded-l-md focus:outline-none focus:ring focus:border-primary md:w-[65%]"
                    />
                    <button
                        type="submit"
                        className="bg-secondary text-white py-2 px-4 rounded-r-md"
                    >
                        Get Started
                    </button>
            ...
            {/* Divider Line */}
            <div className="border-t border-[#373435] my-8"></div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div className="col-span-1 flex justify-center items-center">
                    ...
                    <Link href="https://instagram.com/all_talentz?igshid=MzRlODBiNWFlZA==" target='_blank'>
