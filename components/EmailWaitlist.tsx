...
export const EmailWaitlist = ({ name, email, yoe, phone, career }: EmailWaitlistProps) => {
  return (
    <Html>
      <Head />
      <Tailwind>
        <Body className="mx-auto my-auto bg-white font-sans">
          <Container className="mx-auto my-[40px] w-[465px] rounded border border-solid border-secondary p-[20px]">
            ...
            <Text className="text-[14px] leading-[24px] text-black">
              You got an email from <strong>{name}</strong>. Whose email is {email}.<br />
              <span className="font-bold">The message</span>: <br />
              Hi, I Want to be on your Waitlist <br />
              <span className="font-bold">Phone Number</span>: {phone}
              <br />
              <span className="font-bold">Years of Experience</span> : {yoe}
              <br />
