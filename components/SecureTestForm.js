	...
	useEffect(() => {
		...
		const handleKeyDown = (e) => {
			...
			if (e.ctrlKey || e.metaKey) {
				...
				if (
					["c", "v", "x", "a", "s", "p", "C", "V", "X", "A", "S", "P"].includes(
						e.key,
					)
				) {
					e.preventDefault();
					...
					e.stopImmediatePropagation();
					alert(
						"⚠️ Copy, paste, and other shortcuts are disabled during the test.",
					);
					return false;
				}
				...
				if (["w", "W"].includes(e.key)) {
					if (
						!confirm(
							"⚠️ Are you sure you want to close this tab? Your progress may be lost.",
						)
					) {
						e.preventDefault();
						e.stopPropagation();
						...
						<div className="space-y-4 mb-6">
							<div className="bg-blue-50 border-l-4 border-blue-500 p-4">
								<h3 className="font-semibold text-blue-800 mb-2">
									To have a seamless onboarding on Savewyze, kindly follow the
									instructions below:
								</h3>
							</div>
							...
							<div className="space-y-3 text-gray-700">
								<div className="flex items-start">
									...
									<p className="flex-1">
										Ensure you have your <strong>NIN slip or card</strong> in
										your possession
									</p>
								</div>
								...
								<div className="flex items-start">
									...
									<p className="flex-1">
										Ensure you fill in your{" "}
										<strong>First Name and Last Name</strong> as seen on your
										NIN slip or card (<strong>Not your Middle Name</strong>).
										This makes your NIN verification process seamless
									</p>
								</div>
								...
								<div className="flex items-start">
									...
									<p className="flex-1">
										Your <strong>Wyze tag</strong> is a unique handle (like a
										Nickname) you can decide what that should be.
									</p>
								</div>
							</div>
							...
							<div className="bg-yellow-50 border-l-4 border-yellow-500 p-4 mt-4">
								...
								<ul className="text-sm text-gray-700 space-y-1 ml-4">
									<li>
										• For <strong>Savewyze onboarding issues only</strong>,
										kindly reach out to{" "}
										<a
									...
									<li>
										• For <strong>test difficulties or technical issues</strong>
										, please contact{" "}
										<a
			...
			<div className="w-full h-screen bg-gray-100 flex flex-col items-center justify-center p-4">
				<div className="w-full max-w-6xl bg-white rounded-lg shadow-lg overflow-hidden p-8 text-center">
					...
					<p className="text-gray-600">
						Please wait while we redirect you to the assessment test.
					</p>
				</div>
			</div>
		);
			...
			>
				<div className="bg-[#F99621] text-white p-4 text-center">
					...
					<p className="text-sm mt-2">
						Please complete this test to advance to the next stage.
					</p>
				</div>
				<div
