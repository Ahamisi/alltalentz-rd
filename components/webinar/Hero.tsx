      ...
      <div className="relative container mx-auto px-6 flex flex-col items-center lg:flex-row lg:items-center lg:justify-between lg:px-[80px]">
        <div className="text-center lg:text-left lg:w-1/2 py-8 md:py-16">
          <h1 className="text-3xl md:text-5xl font-bold text-black leading-tight">
            How to close your{" "}
            <span className="text-[#F99621] text-4xl md:text-8xl">Digital Marketing</span> Sales
            Lead
          </h1>
          ...
          <p className="text-base md:text-5xl text-[#4C4C4C] mt-2 font-bold">
            July 17th, 2024
            <span className="text-[#4C4C4C] font-bold text-sm ">&nbsp; (11.AM EST)</span>
          </p>
        </div>
