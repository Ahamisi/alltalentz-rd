...
export default function RequestTalent() {
  ...
  const handleInputChange = (event: React.ChangeEvent<HTMLInputElement | HTMLSelectElement>) => {
    ...
    if (name === "service") {
      ...
      const selectedOptions = Array.from((event.target as HTMLSelectElement).selectedOptions).map(
        (option) => option.value
      );
      setFormData((prevData) => ({
        ...prevData,
            ...
            <div className="flex flex-col lg:flex-row items-center justify-between w-full">
              ...
              <div className="lg:w-1/2 pr-8">
                ...
                <h1 className="text-4xl lg:text-2xl font-bold leading-tight mb-6 text-black">
                  ...
                  <br />
                  Exclusive <span className="text-[#F99621]">5% Partner Discount</span> for Alacrity
                  Members
                </h1>
                ...
                <div className="flex items-center gap-6">
                  <Link
                    ...
                    className="bg-[#F99621] text-black px-8 py-3  font-medium"
                  >
                    Meet with us!
                  </Link>
                  <Image
                    src="/alacrity-logo.png"
                    alt="Alacrity Solutions"
                    width={120}
                    height={48}
