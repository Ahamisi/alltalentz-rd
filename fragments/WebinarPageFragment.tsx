    ...
    >
      ...
      <section className="md-padding relative bg-cover bg-center bg-no-repeat py-[30px] md:py-[128px] bg-[#282828] px-[15px] md:px-0">
        ...
        <div className="py-16 text-white">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 text-center lg:w-[70%] lg:mx-auto"></div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-6 text-center mt-[30px] md:mt-[60px] lg:w-[70%] lg:mx-auto">
              <div className="">
                ...
                />
                <h3 className="text-lg md:text-[35px] font-semibold mt-5 md:leading-[40px]">
                  Sadiq <br />
                  Isu&nbsp;<span className="text-[12px]">MBA</span>
                </h3>
              ...
              <div className="">
                ...
                <p className="text-[16px] text-secondary">
                  Business and Digital Solutions Director
                </p>
              </div>
      ...
      <section className="bg-[#FEF5E9] px-8 md:px-[120px] py-[83px]">
        <div className="mb-[48px]">
          <h2 className="text-[#121212] font-bold text-2xl md:text-4xl ">
        ...
        <div>
          <ul className="text-[#4C4C4C] list-disc">
            <li className="mb-5">
              The customer journey and identify where leads are slipping away. 
            </li>
        ...
        <div className="flex py-4 md:py-[40px] justify-start lg:justify-start">
          <a
            href="https://events.teams.microsoft.com/event/279aa6e0-9f31-421e-b3a8-ff11094a607a@8905187e-0732-4a0a-ae4d-83be05131105"
            target="_blank"
            className="bg-[#F99621] hover:bg-[#282828] text-[#121212] hover:text-white px-8 md:px-[63px] py-4 md:py-[23px] transition duration-300 text-sm md:text-base"
          >
            Register Now
          </a>
        </div>
