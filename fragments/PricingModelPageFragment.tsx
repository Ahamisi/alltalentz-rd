			...
			<div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
				...
				<div className="space-y-8">
					<h2 className="text-4xl font-bold text-[#1A1A1A] leading-tight">
						Are you ready to take your career to the next level with world class
						training?
					</h2>

					<p className="text-xl text-gray-600">
						Don't miss this opportunity to join us today and start your journey
						to a global career!
					</p>

					<div className="space-y-6">
						<div className="flex items-center gap-4">
							<Image src="/icons/work-life.svg" alt="Work-life balance" width={32} height={32} className="w-8 h-8" />
							<span className="text-lg text-[#353535]">
								Healthy work-life Balance
							</span>
						</div>

						<div className="flex items-center gap-4">
							<Image src="/icons/remote.svg" alt="Remote work" width={32} height={32} className="w-8 h-8" />
							<span className="text-lg text-[#353535]">
						...
						<div className="flex items-center gap-4">
							<Image src="/icons/employee-benefits.svg" alt="Employee benefits" width={32} height={32} className="w-8 h-8" />
							<span className="text-lg text-[#353535]">
						...
						<div className="flex items-center gap-4">
							<Image src="/icons/compensation.svg" alt="Compensation" width={32} height={32} className="w-8 h-8" />
