  ...
  return (
    ...
    <section className="overflow-scroll relative overflow-y-scroll">
      {/* <section className="relative bg-cover bg-center bg-no-repeat text-[#4C4C4C] py-[70px] bg-white px-[30px] md:px-0" style={{ backgroundImage: "url('/our-values-bg.svg')" }}>
        ...
        <div className="md:w-[93%] md:ml-auto md:mr-auto">
            <div className="p-2 bg-[#F99621] items-center text-white leading-none lg:rounded-full flex lg:inline-flex" role="alert">
                <span className=" rounded-full bg-orange-500 uppercase px-2 py-1 text-xs font-bold mr-3 hidden md:flex">Important</span>
                <span className="font-semibold mr-2 text-left flex-auto">Hey there test taker, please ensure you click the submit button before the timer runs out. We dont automatically submit for you !</span>
