      ...
      <section className="overflow-scroll relative overflow-y-scroll">
        ...
        <div className="bg-transparent text-center py-4 mb-8 lg:px-4 fixed bottom-0 md:top-0 md:bottom-auto w-full">
          <div className="md:w-[93%] md:ml-auto md:mr-auto">
            <div
              className="p-2 bg-[#F99621] items-center text-white leading-none lg:rounded-full flex lg:inline-flex"
              role="alert"
            >
              <span className=" rounded-full bg-orange-500 uppercase px-2 py-1 text-xs font-bold mr-3 hidden md:flex">
                Important
              </span>
              <span className="font-semibold mr-2 text-left flex-auto">
                Hey there test taker, please ensure you click the submit button before the timer
                runs out. We dont automatically submit for you !
              </span>
              <svg
