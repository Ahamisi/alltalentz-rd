          ...
          <div className="max-w-6xl mx-auto md:px-4 px-0 py-12 md:flex relative h-fit mt-0 items-center ">
            ...
            <div className="md:w-6/10 pr-6 md:w-full">
              ...
              <p className="text-white text-md">
                Learn about our latest developments and how they can benefit your business growth.
                We provide valuable insights and tips to help you optimize your operations.
              </p>
            </div>
