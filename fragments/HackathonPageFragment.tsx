...
export default function Hackathon() {
  const [openRules, setOpenRules] = useState<Record<string | number, boolean>>({});
  const [openFaqs, setOpenFaqs] = useState<Record<string | number, boolean>>({});
      ...
      <main className="relative overflow-hidden">
              ...
              <div className="flex flex-col md:flex-row items-center justify-center gap-8 mb-16">
                ...
                <div className="max-w-md text-left md:text-left">
                  <p className="text-gray-600 leading-relaxed text-md">
                    Calling all young innovators — build solutions that drive real impact, compete
                    for a ₦10M prize, and gain global career opportunities.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section id="what-is" className="bg-white py-16 px-4 md:px-8">
          <div className="max-w-6xl mx-auto">
            ...
            <p className="text-lg md:text-xl text-gray-700 leading-relaxed max-w-4xl">
              Join us this August for Nigeria's leading Hackathon. Build solutions, win ₦10M in
              prizes, and connect with top investors and industry leaders.
            </p>
          </div>
        </section>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12 bg-[#F8F8F8] p-6 rounded-xl">
              ...
              <div className="text-left">
                ...
                <div className="space-y-3 text-gray-600 text-sm md:text-base">
                  <p>
                    Teams submit a written problem statement and a proposed solution (max 500
                    words).
                  </p>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
              ...
              <div className="text-left">
                <div className="mb-6">
                  ...
                  <div className="h-2 w-3/5" style={{ backgroundColor: "#727272" }}></div>
                </div>
                <h3 className="text-xl font-semibold text-gray-800 mb-3">Call for submission</h3>
                <p className="text-gray-600 text-sm md:text-base">Sign up for the Hackathon.</p>
              </div>
              ...
              <div className="text-left">
                ...
                <h3 className="text-xl font-semibold text-gray-800 mb-3">Registration Deadline</h3>
                <p className="text-gray-600 text-sm md:text-base">Goodluck on your submissions!</p>
              </div>
              ...
              <div className="text-left">
                ...
                <p className="text-gray-600 text-sm md:text-base">Get ready for the main event!</p>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="space-y-12">
              ...
              <div className="flex items-start gap-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex flex-col items-start">
                    ...
                    <div className="h-2 w-32" style={{ backgroundColor: "#727272" }}></div>
                  </div>
                </div>

                {/* Content */}
                <div className="flex-1">
                  <h3 className="text-xl font-semibold text-gray-800 mb-2">July 21, 2025.</h3>
              ...
              <div className="flex items-start gap-6">
                ...
                {/* Content */}
                <div className="flex-1">
                  <h3 className="text-xl font-semibold text-gray-800 mb-2">July 28, 2025</h3>
                  <p className="text-gray-600 text-sm md:text-base">
              ...
              <div className="flex items-start gap-6">
                ...
                {/* Content */}
                <div className="flex-1">
                  <h3 className="text-xl font-semibold text-gray-800 mb-2">August 4, 2025</h3>
                  <p className="text-gray-600 text-sm md:text-base">Testing, integration, polish</p>
                </div>
              ...
              <div className="flex items-start gap-6">
                ...
                {/* Content */}
                <div className="flex-1">
                  <h3 className="text-xl font-semibold text-gray-800 mb-2">August 11, 2025</h3>
                  <p className="text-gray-600 text-sm md:text-base">
            ...
            <div className="flex items-start gap-6">
              ...
              <div className="flex-1">
                ...
                <div className="flex flex-col items-start mb-6">
                  ...
                  <div className="h-2 w-40" style={{ backgroundColor: "#727272" }}></div>
                </div>
        ...
        <section id="prizes" className="bg-white py-16 px-4 md:px-8">
          <div className="max-w-6xl mx-auto">
            ...
            {/* Grand Prize Section */}
            <div className="text-center mb-16">
              <h3 className="text-3xl md:text-4xl font-bold text-gray-800 mb-6">Grand Prize</h3>
              <p className="text-lg md:text-xl text-gray-600 mb-8 max-w-4xl mx-auto">
                ₦10,000,000 cash + Trophy + Sponsored trip to TechCrunch Disrupt 2025 in San
                Francisco.
              </p>
            ...
            <div className="bg-[#F8F8F8] p-8 md:p-10 rounded-xl">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
                ...
                <div className="text-left">
                  ...
                  <p className="text-gray-600 text-sm leading-relaxed">
                    Special recognition for the most creative and forward-thinking solution —
                  ...
                  <Link href="https://www.linkedin.com/company/all-talentz/" target="_blank">
                    ...
                    >
                      ...
                      <path
                        fillRule="evenodd"
                        clipRule="evenodd"
                        d="M13.7556 10.91C13.7556 11.8221 13.0611 12.5602 11.975 12.5602C10.9313 12.5602 10.2368 11.8221 10.2583 10.91C10.2368 9.95352 10.9313 9.23688 11.9958 9.23688C13.0611 9.23688 13.7348 9.95352 13.7556 10.91ZM10.3456 24.488V13.8639H13.6474V24.4873H10.3456V24.488Z"
                        fill="#131313"
                      />
                      <path
                        fillRule="evenodd"
                        clipRule="evenodd"
                        d="M16.2943 17.2545C16.2943 15.9294 16.2507 14.7996 16.207 13.8654H19.075L19.2274 15.3209H19.2926C19.7271 14.6472 20.8132 13.627 22.5729 13.627C24.7451 13.627 26.3745 15.0609 26.3745 18.1881V24.4895H23.0726V18.6019C23.0726 17.2324 22.5951 16.2988 21.4002 16.2988C20.4875 16.2988 19.9448 16.9288 19.7278 17.5366C19.6405 17.7542 19.5975 18.0578 19.5975 18.3627V24.4895H16.2957V17.2545H16.2943Z"
                        fill="#131313"
                      />
                    </svg>
                  </Link>
            ...
            <div className="bg-white rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto relative shadow-lg">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-700 text-sm">
                  <span className="font-bold">1. Eligibility</span> <br />
                  <br />
                  <span className="">
                    1.1 This Hackathon is open to individuals who have attained the age of eighteen
                    (18) years at the time of registration and who possess the legal capacity to
                    participate under applicable laws. <br />
                    <br />
                    1.2 Participation may occur individually or as part of a team comprising no
                    fewer than three (3) and no more than five (5) members. <br />
                    <br />
                    1.3 Employees, affiliates, mentors, or judges affiliated with the organizing
                    entity shall not be eligible to participate as contestants. <br />
                    <br />
                    1.4 Any falsified registration information shall be grounds for
                    disqualification, at the sole discretion of the organizers. <br />
                    <br />
                  </span>
                </p>

                <p className="text-gray-700 text-sm">
                  <span className="font-bold">2. Registration and Participation</span> <br />
                  <br />
                  <span className="">
                    2.1 Registration shall be completed exclusively via the official platform
                    designated by the organizers. <br />
                    <br />
                    2.2 Participants must explicitly accept these Terms and Conditions as a
                    precondition to participation. <br />
                    <br />
                    2.3 Only submissions made within the stipulated deadline shall be considered
                    eligible. <br />
                    <br />
                    2.4 All official communications shall be conducted via Slack, Microsoft Teams,
                    or any other channel communicated by the organizers. <br />
                    <br />
                    2.5 All participant information collected during registration shall be used
                    exclusively for Hackathon coordination and future talent pipeline opportunities,
                    in compliance with the Nigeria Data Protection Regulation (NDPR). <br />
                    <br />
                  </span>
                </p>

                <p className="text-gray-700 text-sm">
                  <span className="font-bold">3. Event Structure and Timeline</span> <br />
                  <br />
                  <span className="">
                    3.1 The Hackathon shall be conducted in three (3) principal phases: (i)
                    Submission and Shortlisting; (ii) Mentorship and Development; and (iii) Demo Day
                    and Final Judging. <br />
                    <br />
                ...
                <p className="text-gray-700 text-sm">
                  <span className="font-bold">4. Judging and Appeals</span> <br />
                  <br />
                  <span className="">
                    4.1 Submissions shall be assessed based on the following criteria: Innovation
                    (30%), Feasibility (25%), Impact (25%), and Presentation (20%). <br />
                    <br />
                    4.2 Judging shall follow a blind review process in the initial phase to reduce
                    bias. <br />
                    <br />
                    4.3 In the event of a scoring tie, teams with a working prototype will be
                    prioritized over idea-only submissions. <br />
                    <br />
                    4.4 Participants may appeal judging outcomes within forty-eight (48) hours of
                    result announcements. Appeals will be reviewed by an independent committee.{" "}
                    <br />
                    <br />
                  </span>
                </p>
                ...
                <p className="text-gray-700 text-sm">
                  <span className="font-bold">5. Mentorship Support</span> <br />
                  <br />
                  <span className="">
                    5.1 Each team shall be assigned a mentor based on relevant expertise. Mentors
                    shall provide non-binding advisory support. <br />
                    <br />
                    5.2 Mentors must support all assigned teams equitably and must not claim
                    ownership over any team’s work. <br />
                    <br />
                  </span>
                </p>

                <p className="text-gray-700 text-sm">
                  <span className="font-bold">6. Intellectual Property Rights</span> <br />
                  <br />
                  <span className="">
                    6.1 All intellectual property developed during the Hackathon shall be jointly
                    owned by the participants and organizers on a 50/50 basis, unless otherwise
                    agreed in writing. <br />
                    <br />
                    6.2 Unauthorized use of another team's work will result in immediate
                    disqualification. <br />
                    <br />
                    6.3 Participants represent and warrant that their submissions do not infringe
                    upon third-party rights. <br />
                    <br />
                  </span>
                </p>

                <p className="text-gray-700 text-sm">
                  <span className="font-bold">7. Code of Conduct and Ethics</span> <br />
                  <br />
                  <span className="">
                    7.1 Participants, mentors, judges, and organizers must uphold fairness,
                    transparency, and professionalism throughout the Hackathon. <br />
                    <br />
                    7.2 Any form of harassment, discrimination, or unethical behavior shall result
                    in immediate disqualification. <br />
                    <br />
                    7.3 Judges must maintain impartiality and confidentiality. <br />
                    <br />
                    7.4 Organizers must disclose any conflicts of interest with participating teams.{" "}
                    <br />
                    <br />
                  </span>
                </p>
                ...
                <p className="text-gray-700 text-sm">
                  <span className="font-bold">8. Inclusivity and Accessibility</span> <br />
                  <br />
                  <span className="">
                    8.1 The Hackathon is committed to providing a welcoming and inclusive
                    environment for all participants regardless of gender, background, or
                    disability. <br />
                    <br />
                    8.2 Reasonable accommodations shall be provided for participants with
                    disabilities (e.g., captioning, assistive technologies). <br />
                    <br />
                  </span>
                </p>

                <p className="text-gray-700 text-sm">
                  <span className="font-bold">9. Prizes and Recognition</span> <br />
                  <br />
                  <span className="">
                    9.1 Prizes shall be awarded to the top three (3) teams as determined by
                    cumulative scores. <br />
                    <br />
                    9.2 Additional non-monetary benefits may include incubation support, employment
                    referrals, or sponsorship opportunities. <br />
                    <br />
                    9.3 Participation does not guarantee post-event employment but enhances
                    visibility within the talent pipeline. <br />
                    <br />
                  </span>
                </p>
                ...
                <p className="text-gray-700 text-sm">
                  ...
                  <span className="">
                    10.1 The organizers reserve the right to amend any part of the Hackathon
                    structure, rules, or deadlines. <br /> <br />
                ...
                <p className="text-gray-700 text-sm">
                  <span className="font-bold">11. Limitation of Liability</span> <br />
                  <br />
                  <span className="">
                    11.1 The organizers shall not be held liable for any data loss, injury, or other
                    damages incurred during or as a result of participation in the Hackathon. <br />
                    <br />
                  </span>
                </p>

                <p className="text-gray-700 text-sm">
                  <span className="font-bold">12.Governing Law and Jurisdiction</span> <br />
                  <br />
                  <span className="">
                    12.1 These Terms and Conditions shall be governed by and construed in accordance
                    with the laws of the Federal Republic of Nigeria. <br />
                    <br />
                    12.2 Any disputes shall be resolved exclusively by the competent courts in
                    Nigeria. <br />
                    <br />
                  </span>
                </p>
                ...
                <p className="text-gray-700 text-sm">
                  <span className="font-bold">13. Contact and Grievance Reporting</span> <br />
                  <br />
                  <span className="">
                    13.1 Participants may report ethical concerns or violations via the following:{" "}
                    <br />
                    <br />
                    Email: ethics@alltalentz.com <br />
                    Hotline: +2347035089708 <br />
                    <br />
                  </span>
                </p>
                ...
                <p className="text-gray-700 text-sm">
                  ...
                  <span className="">
                    ...
                    bound by these Terms and Conditions in their entirety. <br />
                    <br />
                    By ticking the checkbox below or providing your digital signature, you confirm
                    that you have read, understood, and agree to be legally bound by the Hackathon
                    Terms and Conditions provided by the organizers. <br />
                    <br />
                    You further acknowledge and accept that: <br />
                    <br />
                    - Your intellectual property rights may be shared with the organizers on a 50/50
                    basis. <br />
                    <br />
                    - Your personal data may be collected and used strictly for event coordination
                    and talent pipeline opportunities. <br />
                    <br />
                    - You will comply with the Code of Conduct, deadlines, and all Hackathon rules
                    as communicated. <br />
                    <br />- Any violation may lead to disqualification or legal recourse under the
