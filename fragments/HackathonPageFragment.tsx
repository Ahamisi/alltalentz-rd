							...
							<div className="flex flex-col md:flex-row items-center justify-center gap-8 mb-16">
								...
								<div className="max-w-md text-left md:text-left">
									<p className="text-gray-600 leading-relaxed text-md">
										Calling all young innovators — build solutions that drive
										real impact, compete for a ₦10M prize, and gain global
				...
				<section id="what-is" className="bg-white py-16 px-4 md:px-8">
					<div className="max-w-6xl mx-auto">
						...
						<p className="text-lg md:text-xl text-gray-700 leading-relaxed max-w-4xl">
							Join us this August for Nigeria's leading Hackathon. Build
							solutions, win ₦10M in prizes, and connect with top investors and
							industry leaders.
						</p>
					</div>
				</section>
						...
						<div className="grid md:grid-cols-3 gap-6 lg:gap-8 md:bg-[#F8F8F8] md:p-10 text-left md:rounded-xl">
							...
							<div className="bg-[#F8F8F8] p-6 rounded-xl md:bg-transparent md:p-0 md:rounded-none">
								...
								<p className="text-gray-600 text-sm md:text-base leading-relaxed mb-6">
									Pick from 8 challenge tracks and build real-world tech
									solutions.
								</p>
								<a
									href="#challenge-tracks"
							...
							<div className="bg-[#F8F8F8] p-6 rounded-xl md:bg-transparent md:p-0 md:rounded-none">
								...
								<p className="text-gray-600 text-sm md:text-base leading-relaxed mb-6">
									You will create a disruptive and innovative idea for the
					...
					<div className="max-w-6xl mx-auto">
						...
						<div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12 bg-[#F8F8F8] p-6 rounded-xl">
							...
							<div className="text-left">
								...
								<div className="space-y-3 text-gray-600 text-sm md:text-base">
									<p>
										Teams submit a written problem statement and a proposed
										solution (max 500 words).
									</p>
								</div>
							</div>
					...
					<div className="max-w-6xl mx-auto">
						...
						<div className="text-center mb-16">
							...
							<p className="text-lg md:text-xl text-gray-600 mb-8 max-w-4xl mx-auto">
								₦10,000,000 cash + Trophy + Sponsored trip to TechCrunch Disrupt
								2025 in San Francisco.
							</p>
							<p className="text-lg md:text-xl text-gray-600 max-w-4xl mx-auto">
								To win, your solution must deliver impact, innovation, and
								scalability.
							</p>
						</div>
							...
							<div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
								...
								<div className="text-left">
									...
									<p className="text-gray-600 text-sm leading-relaxed">
										₦2,000,000 cash prize + trophy + spotlight in All Talentz
										talent network.
									</p>
								</div>
								...
								<div className="text-left">
									...
									<p className="text-gray-600 text-sm leading-relaxed">
										Special recognition for the most creative and
										forward-thinking solution — mentorship + networking
										opportunities.
									</p>
								</div>
							</div>
						...
						<div className="">
							...
							<div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
								...
								<div className="col-span-1 text-white text-center text-sm md:text-auto">
									...
									<br />© {new Date().getFullYear()} All Talentz LLC. All rights
									reserved.
								</div>
						...
						<div className="bg-white rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto relative shadow-lg">
							...
							<div className="p-6">
								...
								<p className="text-gray-700 text-sm">
									...
									<br />
									<span className="">
										1.1 This Hackathon is open to individuals who have attained
										the age of eighteen (18) years at the time of registration
										and who possess the legal capacity to participate under
										applicable laws. <br />
										<br />
										1.2 Participation may occur individually or as part of a
										team comprising no fewer than three (3) and no more than
										five (5) members. <br />
										<br />
										1.3 Employees, affiliates, mentors, or judges affiliated
										with the organizing entity shall not be eligible to
										participate as contestants. <br />
										<br />
										1.4 Any falsified registration information shall be grounds
										for disqualification, at the sole discretion of the
										organizers. <br />
										<br />
									</span>
								</p>
								...
								<p className="text-gray-700 text-sm">
									...
									<br />
									<span className="">
										2.1 Registration shall be completed exclusively via the
										official platform designated by the organizers. <br />
										<br />
										2.2 Participants must explicitly accept these Terms and
										Conditions as a precondition to participation. <br />
										<br />
										2.3 Only submissions made within the stipulated deadline
										shall be considered eligible. <br />
										<br />
										2.4 All official communications shall be conducted via
										Slack, Microsoft Teams, or any other channel communicated by
										the organizers. <br />
										<br />
										2.5 All participant information collected during
										registration shall be used exclusively for Hackathon
										coordination and future talent pipeline opportunities, in
								...
								<p className="text-gray-700 text-sm">
									<span className="font-bold">
										3. Event Structure and Timeline
									</span>{" "}
									<br />
									<br />
									<span className="">
										3.1 The Hackathon shall be conducted in three (3) principal
										phases: (i) Submission and Shortlisting; (ii) Mentorship and
										Development; and (iii) Demo Day and Final Judging. <br />
										<br />
										3.2 Each phase will be governed by timelines communicated in
										advance by the organizers. <br />
										<br />
									</span>
								</p>

								<p className="text-gray-700 text-sm">
									<span className="font-bold">4. Judging and Appeals</span>{" "}
									<br />
									<br />
									<span className="">
										4.1 Submissions shall be assessed based on the following
										criteria: Innovation (30%), Feasibility (25%), Impact (25%),
										and Presentation (20%). <br />
										<br />
										4.2 Judging shall follow a blind review process in the
										initial phase to reduce bias. <br />
										<br />
										4.3 In the event of a scoring tie, teams with a working
										prototype will be prioritized over idea-only submissions.{" "}
										<br />
										<br />
										4.4 Participants may appeal judging outcomes within
										forty-eight (48) hours of result announcements. Appeals will
										be reviewed by an independent committee. <br />
										<br />
									</span>
								</p>

								<p className="text-gray-700 text-sm">
									<span className="font-bold">5. Mentorship Support</span>{" "}
									<br />
									<br />
									<span className="">
										5.1 Each team shall be assigned a mentor based on relevant
										expertise. Mentors shall provide non-binding advisory
										support. <br />
										<br />
										5.2 Mentors must support all assigned teams equitably and
										must not claim ownership over any team’s work. <br />
										<br />
									</span>
								</p>
								...
								<p className="text-gray-700 text-sm">
									...
									<br />
									<span className="">
										6.1 All intellectual property developed during the Hackathon
										shall be jointly owned by the participants and organizers on
										a 50/50 basis, unless otherwise agreed in writing. <br />
										<br />
										6.2 Unauthorized use of another team's work will result in
										immediate disqualification. <br />
										<br />
										6.3 Participants represent and warrant that their
										submissions do not infringe upon third-party rights. <br />
										<br />
									</span>
								</p>
								...
								<p className="text-gray-700 text-sm">
									...
									<br />
									<span className="">
										7.1 Participants, mentors, judges, and organizers must
										uphold fairness, transparency, and professionalism
										throughout the Hackathon. <br />
										<br />
										7.2 Any form of harassment, discrimination, or unethical
										behavior shall result in immediate disqualification. <br />
										<br />
										7.3 Judges must maintain impartiality and confidentiality.{" "}
										<br />
										<br />
										7.4 Organizers must disclose any conflicts of interest with
								...
								<p className="text-gray-700 text-sm">
									...
									<br />
									<span className="">
										8.1 The Hackathon is committed to providing a welcoming and
										inclusive environment for all participants regardless of
										gender, background, or disability. <br />
										<br />
										8.2 Reasonable accommodations shall be provided for
										participants with disabilities (e.g., captioning, assistive
										technologies). <br />
										<br />
									</span>
								</p>
								...
								<p className="text-gray-700 text-sm">
									<span className="font-bold">9. Prizes and Recognition</span>{" "}
									<br />
									<br />
									<span className="">
										9.1 Prizes shall be awarded to the top three (3) teams as
										determined by cumulative scores. <br />
										<br />
										9.2 Additional non-monetary benefits may include incubation
										support, employment referrals, or sponsorship opportunities.{" "}
										<br />
										<br />
										9.3 Participation does not guarantee post-event employment
										but enhances visibility within the talent pipeline. <br />
										<br />
									</span>
								</p>

								<p className="text-gray-700 text-sm">
									<span className="font-bold">10. Organizer Rights</span> <br />{" "}
									<br />
									<span className="">
										10.1 The organizers reserve the right to amend any part of
										the Hackathon structure, rules, or deadlines. <br /> <br />
										10.2 The organizers may disqualify any team found to be in
										breach of these Terms and Conditions. <br /> <br />
									</span>
								</p>
								...
								<p className="text-gray-700 text-sm">
									...
									<br />
									<span className="">
										11.1 The organizers shall not be held liable for any data
										loss, injury, or other damages incurred during or as a
										result of participation in the Hackathon. <br />
										<br />
									</span>
								</p>
								...
								<p className="text-gray-700 text-sm">
									...
									<span className="">
										...
										<br />
										12.2 Any disputes shall be resolved exclusively by the
										competent courts in Nigeria. <br />
										<br />
									</span>
								</p>
								...
								<p className="text-gray-700 text-sm">
									<span className="font-bold">
										13. Contact and Grievance Reporting
									</span>{" "}
									<br />
									<br />
									<span className="">
										13.1 Participants may report ethical concerns or violations
										via the following: <br />
										<br />
								...
								<p className="text-gray-700 text-sm">
									<span className="font-bold">14. Acceptance</span> <br />{" "}
									<br />
									<span className="">
										14.1 By participating in the Hackathon, participants
										acknowledge and agree to be bound by these Terms and
										Conditions in their entirety. <br />
										<br />
										By ticking the checkbox below or providing your digital
										signature, you confirm that you have read, understood, and
										agree to be legally bound by the Hackathon Terms and
										Conditions provided by the organizers. <br />
										<br />
										You further acknowledge and accept that: <br />
										<br />
										- Your intellectual property rights may be shared with the
										organizers on a 50/50 basis. <br />
										<br />
										- Your personal data may be collected and used strictly for
										event coordination and talent pipeline opportunities. <br />
										<br />
										- You will comply with the Code of Conduct, deadlines, and
										all Hackathon rules as communicated. <br />
										<br />
										- Any violation may lead to disqualification or legal
										recourse under the laws of the Federal Republic of Nigeria.{" "}
										<br />
										<br />
									</span>
								</p>
