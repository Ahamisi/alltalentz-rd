...
export default function Watchlist() {
  ...
  const [formData, setFormData] = useState<{fullName: string; email: string; yoe: string; career: string; phone: string; cv: string | File | null}>({
      fullName: "",
      email: "",
      yoe: "",
      career: "",
                        ...
                        <div className="modal-content p-3 w-[100] md:w-[80%] mx-auto overflow-y-auto">
                            ...
                            {isSubmitted ? (
                               <div className=" p-4 rounded-lg bg-[##FDDEBA] text-center mt-6 bg-white w-full m-0">
                                    ...
                                    <Btn link="https://alltalentz.com/cbt" target="_blank" text="Take Test Now" otherCSS="mt-6" />
                                </div>
                            ) : (
