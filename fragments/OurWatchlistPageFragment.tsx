  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    if (validateForm()) {
      try {
        ...
        if (formData.cv) newFData.append("cv", formData.cv as string | Blob);
          ...
          <div className="max-w-6xl mx-auto py-12 lg:flex relative h-fit mt-0 items-center px-[20px] md:px-4 ">
            ...
            <div className="md:w-6/10 pr-6 md:w-full">
              ...
              <p className="text-white text-sm md:text-base">
                Join us and discover the world of opportunities and growth that await you. You'll
                learn new skills and explore new cultures from the comfort of your home. Don't miss
                this chance to grow professionally and personally. Start your global adventure
                today!
              </p>
                  ...
                  {isSubmitted ? (
                    <div className=" p-4 rounded-lg bg-[##FDDEBA] text-center mt-6 bg-white w-full m-0">
                      ...
                      <p className="text-gray-600">
                        Wait while we redirect you to the test portal in {countdown} seconds.
                      </p>
                      <br />

                      <Btn
                        link="https://alltalentz.com/cbt"
                        target="_blank"
                        text="Take Test Now"
                        otherCSS="mt-6"
                      />
                    ...
                    >
                      <h2 className="text-lg font-normal text-center mb-8 text-[#939393]">
                        Kindly fill this form and upload your CV to keep yourself in the loop
                      </h2>
                      ...
                      <div className="mb-8">
                        ...
                        >
                          ...
                          <p>
                            Hey there, once you click submit, you would be redirected to take a
                            compulsory test as the final stage.
                          </p>
                        </div>
                      </div>
        ...
        <div className="relative inset-0 flex flex-col items-center justify-center text-[#4C4C4C]">
              ...
              <div className="text-4xl mr-4 text-[#4C4C4C] text-center">
                ...
                >
                  <path
                    fillRule="evenodd"
                    clipRule="evenodd"
                    d="M6.15233 16.648C7.4081 16.3341 8.6806 17.0976 8.99454 18.3534L10.1882 23.128C12.0939 30.7507 18.0991 36.6607 25.7349 38.4531H50.4708C57.0053 38.4531 62.5053 43.344 63.2688 49.8338L65.2984 67.0855C65.4497 68.371 64.5301 69.5358 63.2446 69.687C61.959 69.8383 60.7943 68.9187 60.643 67.6332L58.6134 50.3815C58.1277 46.2524 54.6283 43.1406 50.4708 43.1406H25.2135L24.9623 43.0848C15.4773 40.977 7.99722 33.6911 5.64064 24.2648L4.447 19.4903C4.13306 18.2345 4.89656 16.962 6.15233 16.648Z"
                    fill="#282828"
                  />
                  <path
                    opacity="0.5"
                    d="M25.4707 43.1406V56.4219C25.4707 62.3144 25.4707 65.2607 27.3013 67.0913C29.1319 68.9219 32.0781 68.9219 37.9707 68.9219C43.8633 68.9219 46.8095 68.9219 48.6401 67.0913C50.4707 65.2607 50.4707 62.3144 50.4707 56.4219V43.1406H25.4707Z"
                    fill="#282828"
                  />
          ...
          <div className=" max-w-6xl text-center mt-[40px]">
            <p className="text-base md:text-lg md:font-bold">
              Are you ready to take your career to the next level with world class training? At All
              Talentz, we invest in our new and existing employees so they can deliver the best
              service to our amazing clientele. You can work from anywhere and still be part of a
              global team. Plus, you can enjoy some of the most competitive compensation and
              benefits in Africa. Don't miss this opportunity to join us today and start your
              journey to a global career!{" "}
            </p>
          </div>
        </div>
      </section>
