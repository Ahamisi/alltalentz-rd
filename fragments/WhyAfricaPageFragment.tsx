...
const benefits = [
  {
    ...
    description:
      "Hiring African talent offers significant cost savings without compromising quality. By tapping into a unique pool of skilled African professionals, operational costs can be greatly reduced while at the same time increasing efficiency.",
  },
  {
    icon: "/icons/diverse-skill.svg",
    title: "Diverse Skillset",
    description:
      "African talent brings a unique blend of skills and perspectives to the table. Raised in diverse cultural and economic environments, we often develop strong problem-solving and adaptability skills naturally. This diversity fuels innovation and drives business growth.",
  },
  {
    icon: "/icons/cultural-compatibility.svg",
    title: "Cultural Compatibility",
    description:
      "African professionals are increasingly exposed to global cultures, making us well-suited for international teams. With strong interpersonal skills and a deep understanding of different cultural nuances, seamless collaboration with colleagues from around the world is guaranteed.",
  },
  {
    icon: "/icons/language-proficiency.svg",
    title: "Language Proficiency",
    description:
      "Many African professionals are multilingual, proficient particularly in English language. This linguistic diversity facilitates effective communication with clients and colleagues worldwide, breaking down language barriers and fostering stronger business relationships.",
  },
  {
    icon: "/icons/skilled-workforce.svg",
    title: "Skilled Workforce",
    description:
      "We are experiencing a rapid growth in skilled professionals, particularly in technology, finance, and healthcare. By hiring African talent, you gain access to a highly skilled workforce that can contribute tremendously to your organization's success!",
  },
  {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {benefits.map((benefit, index) => (
            ...
            >
              ...
              <h3 className="text-xl font-bold mb-4 text-[#1A1A1A]">{benefit.title}</h3>
        ...
        <div className="max-w-7xl mx-auto px-4 lg:flex relative h-[100%] items-center py-20">
          ...
          <div className="lg:w-[50%] flex flex-col space-y-8">
            ...
            <p className="text-white text-md md:text-lg font-light leading-relaxed max-w-xl">
              Africa is a continent of immense potential, home to a diverse and dynamic workforce.
              Our people are known for our exceptional work ethic, strong problem-solving skills,
              and high adaptability. We are quick learners, eager to embrace new challenges. We
              strive for excellence, knowledge and we never back down from an opportunity to show a
              wealth of skill and intellect. 
              <br /> <br />
              By partnering with us, you gain access to a global talent pool that can help you
              achieve your business objectives. Our people are ready to contribute to your success,
              offering a unique blend of skills, cultural perspectives, and a fresh approach to
              problem-solving. 
            </p>
              ...
              <div className="mb-12">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-white-800 opacity-70 mb-1">
                      Our friendly team is here to help. Send us a mail;
                    </p>
                    <a href="mailto:info@alltalentz.com" className="text-white">
                      info@alltalentz.com
                    </a>
                  </div>
                </div>
              ...
              <div className="mb-12">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-white-800 opacity-70 mb-2">
                      Say hello to us at our head office
                    </p>
